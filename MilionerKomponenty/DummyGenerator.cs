...
namespace MilionerKomponenty
{
    public class DummyGenerator : IQuestionGenerator
    {
        ...
        {
            new Response("Famous Actors", "Who is the American actor known for his roles in \"Forrest Gump\" and \"Philadelphia\"?", "Tom Hanks", new List<string> { "Robert De Niro", "Al Pacino", "Morgan Freeman", "Denzel Washington", "Jack Nicholson", "Leonardo DiCaprio", "Johnny Depp", "Harrison Ford", "Tom Hanks" }),
            ...
            new Response("Planets", "Which planet is known as the 'Red Planet'?", "Mars", new List<string> { "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune" }),
            new Response("Languages", "What is the most spoken language in the world?", "Mandarin Chinese", new List<string> { "Spanish", "English", "Hindi", "Arabic", "Portuguese", "Bengali", "Russian", "Japanese", "Mandarin Chinese" }),
            ...
            new Response("Sports", "Which sport is played on a court called a 'pitch'?", "Soccer", new List<string> { "Basketball", "Soccer", "Tennis", "Cricket", "Rugby", "Volleyball", "Field Hockey", "Ping Pong" }),
            new Response("Books", "Who is the author of 'To Kill a Mockingbird'?", "Harper Lee", new List<string> { "Ernest Hemingway", "F. Scott Fitzgerald", "Harper Lee", "Mark Twain", "J.D. Salinger", "George Orwell", "Toni Morrison", "Harper Lee" })
        };
            List<Response> responses4 = new List<Response>
        {
            ...
            new Response("Colors", "What color is formed by mixing red and yellow?", "Orange", new List<string> { "Purple", "Green", "Orange" }),
            ...
            new Response("Fruits", "Which fruit is known as the 'King of Fruits'?", "Durian", new List<string> { "Apple", "Banana", "Durian", "Durian" }),
            ...
            List<Response> responses2 = new List<Response>
        {
            ...
            new Response("Drugs", "What is the primary component of opium?", "Morphine", new List<string> { "Codeine", "Heroin", "Morphine" }),
